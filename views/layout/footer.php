        ...
        <div class="footer-top section-padding">
            <div class="container">
                <div class="row">
                        ...
                        <div class="widget-item">
                            ...
                            <div class="widget-body">
                                <address class="contact-block">
                                    <ul>
                                        <li><i class="pe-7s-home"></i> Phố Trịnh Văn Bô</li>
                                        <li><i class="pe-7s-mail"></i> <a href="mailto:yody@gmail.com">yody@gmail.com </a></li>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="widget-item">
                            <h6 class="widget-title">Chính sách và hỗ trợ</h6>
                            <div class="widget-body">
                                <ul class="info-list">
                    ...
                    <div class="col-md-6">
                        <div class="newsletter-wrapper">
                            ...
                            <form class="newsletter-inner" id="mc-form">
                                <input type="email" class="news-field" id="mc-email" autocomplete="off" placeholder="Vui lòng nhập email của bạn" required>
